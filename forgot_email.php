...
<html class="no-js" lang="">
    <head>
      ...
      <title>
        <?php echo get_phrase('Find_email'); ?> | <?php echo $system_name; ?>
      </title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Provide details to find your email</p>

					<form method="post" role="form" id="form_login"
            action="<?php echo base_url();?>index.php?login/forgot_newemail">
						 <div class="form-group has-feedback">
        <input type="name" class="form-control" name="name" placeholder="<?php echo get_phrase('full name as registered at school');?>" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
						
					 <div class="form-group has-feedback">
        <input type="phone" class="form-control" name="phone" placeholder="<?php echo get_phrase('enter_your_registered_mobile_number_with_92');?>" required>
        ...
        <!-- /.col -->
        	...
        	<button type="submit" class="btn btn-primary">Find Email <i class="glyphicon glyphicon-ok-sign"></i></button>
         
<hr>
        <!-- /.col -->
   <a href="<?php echo base_url();?>index.php?login"><cenrter><botton class="label label-success" style="font-size: 12px;" style="margin: 10px;"> <i class="glyphicon glyphicon-ok-sign"></i> Retrun back</a></botton>
				</div>
			</div>
